...
if ($Host.Version.Major -ge 3) {
    ...
    (New-Object Net.WebClient).DownloadFile('https://github.com/GiaSen/BingWallpaper/raw/master/BingWallpaper.xml', $Xml)
    schtasks /Create /XML $Xml /TN '\star2000\BingWallpaper' /F
    Remove-Item $Xml -Force
}

@'
CreateObject("WScript.Shell").Run "powershell -NoProfile -NonInteractive ""[Net.ServicePointManager]::SecurityProtocol = [Net.ServicePointManager]::SecurityProtocol -bor 3072; (New-Object Net.WebClient).DownloadString('https://github.com/GiaSen/BingWallpaper/raw/master/wallup.ps1') | iex""",0
